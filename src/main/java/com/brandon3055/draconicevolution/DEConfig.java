...
public class DEConfig {
    ...
    public static boolean laserSecondaryPercentDamage;
    public static double laserSecondaryDamagePercent;
    public static int laserSecondaryDamageInterval;
    ...
    private static void loadServer() {
...

        {
            ...
            guardianFight.getValue("guardianHealth")
                    ...
                    .setDefaultInt(-99)
                    .onSync((tag, type) -> guardianHealth = tag.getInt() == -99 ? 18000 : tag.getInt());
            guardianFight.getValue("guardianShield")
                    ...
                    .setDefaultInt(-99)
                    .onSync((tag, type) -> guardianShield = tag.getInt() == -99 ? 12000 : tag.getInt());
            ...
            guardianFight.getValue("laserSecondaryPercentDamage")
                    .syncTagToClient()
                    .setComment("Enable secondary beam percentage damage (based on target max health)")
                    .setDefaultBoolean(true)
                    .onSync((tag, type) -> laserSecondaryPercentDamage = tag.getBoolean());

            guardianFight.getValue("laserSecondaryDamagePercent")
                    .syncTagToClient()
                    .setComment("Max health percentage per tick for secondary beam (0.0 - 1.0), 1.0 = 100")
                    .setDefaultDouble(0.5)
                    .onSync((tag, type) -> laserSecondaryDamagePercent = tag.getDouble());

            guardianFight.getValue("laserSecondaryDamageInterval")
                    .syncTagToClient()
                    .setComment("Secondary beam damage interval (ticks), 1 tick = 0.05 seconds")
                    .setDefaultInt(1)
                    .onSync((tag, type) -> laserSecondaryDamageInterval = tag.getInt());
